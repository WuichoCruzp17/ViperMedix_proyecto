...
namespace ViperMedix.WebAPI.Migrations
{
    ...
    [Migration("20200112055123_RemovePluralizingTables")]
    partial class RemovePluralizingTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ViperMedix.WebAPI.Models.PharmacyMaster", b =>
                {
                    ...
                    b.HasIndex("AddressSATId");

                    b.HasIndex("UserId");

                    b.ToTable("PharmacyMaster");
                });
            ...
            modelBuilder.Entity("ViperMedix.WebAPI.Models.ProductListPriceHistory", b =>
                {
                    ...
                    b.ToTable("ProductListPriceHistory");
                });
            ...
            modelBuilder.Entity("ViperMedix.WebAPI.Models.Address", b =>
                {
                    b.HasOne("ViperMedix.WebAPI.Models.AddressType", "AddressType")
                        .WithMany("Addresses")
                        .HasForeignKey("AddressTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ViperMedix.WebAPI.Models.City", "City")
                        .WithMany("Addresses")
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ViperMedix.WebAPI.Models.RoadType", "RoadType")
                        .WithMany("Addresses")
                        .HasForeignKey("RoadTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ViperMedix.WebAPI.Models.StateProvince", "StateProvince")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("ViperMedix.WebAPI.Models.Employee", b =>
                {
                    b.HasOne("ViperMedix.WebAPI.Models.Address", "Address")
                        .WithMany("Employees")
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ViperMedix.WebAPI.Models.Gender", "Gender")
                        .WithMany("Employees")
                        .HasForeignKey("GenderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ViperMedix.WebAPI.Models.JobTitle", "JobTitle")
                        .WithMany("Employees")
                        .HasForeignKey("JobTitleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ViperMedix.WebAPI.Models.MaritalStatus", "MaritalStatus")
                        .WithMany("Employees")
                        .HasForeignKey("MaritalStatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ViperMedix.WebAPI.Models.PharmacyBranch", "PharmacyBranch")
                        .WithMany("Employees")
                        .HasForeignKey("PharmacyBranchId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ViperMedix.WebAPI.Models.Shift", "Shift")
                        .WithMany("Employees")
                        .HasForeignKey("ShiftId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ViperMedix.WebAPI.Models.User", "User")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("ViperMedix.WebAPI.Models.JobTitle", b =>
                {
                    b.HasOne("ViperMedix.WebAPI.Models.Department", "Department")
                        .WithMany("JobTitles")
            ...
            modelBuilder.Entity("ViperMedix.WebAPI.Models.Permission", b =>
                {
                    b.HasOne("ViperMedix.WebAPI.Models.Module", "Module")
                        .WithMany("Permissions")
                        .HasForeignKey("ModuleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ViperMedix.WebAPI.Models.Role", "Role")
                        .WithMany("Permissions")
            ...
            modelBuilder.Entity("ViperMedix.WebAPI.Models.PharmacyBranch", b =>
                {
                    ...
                    b.HasOne("ViperMedix.WebAPI.Models.PharmacyMaster", "PharmacyMaster")
                        .WithMany("PharmacyBranches")
                        .HasForeignKey("PharmacyMasterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ViperMedix.WebAPI.Models.PharmacyMaster", b =>
                {
                    b.HasOne("ViperMedix.WebAPI.Models.AddressSat", "AddressSAT")
                        .WithMany("PharmacyMasters")
                        .HasForeignKey("AddressSATId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ViperMedix.WebAPI.Models.Product", b =>
                {
                    b.HasOne("ViperMedix.WebAPI.Models.ActiveSubstance", "ActiveSubstance")
                        .WithMany("Products")
                        .HasForeignKey("ActiveSubstanceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ViperMedix.WebAPI.Models.ProductSubCategory", "ProductSubCategory")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ViperMedix.WebAPI.Models.ProductCostHistory", b =>
                {
                    b.HasOne("ViperMedix.WebAPI.Models.Product", "Product")
            ...
            modelBuilder.Entity("ViperMedix.WebAPI.Models.ProductSubCategory", b =>
                {
                    b.HasOne("ViperMedix.WebAPI.Models.ProductCategory", "ProductCategory")
            ...
            modelBuilder.Entity("ViperMedix.WebAPI.Models.SalesOrderDetails", b =>
                {
                    ...
                    b.HasOne("ViperMedix.WebAPI.Models.SalesOrder", "SalesOrder")
                        .WithMany("SalesOrderDetails")
            ...
            modelBuilder.Entity("ViperMedix.WebAPI.Models.StateProvince", b =>
                {
                    b.HasOne("ViperMedix.WebAPI.Models.CountryRegion", "CountryRegion")
